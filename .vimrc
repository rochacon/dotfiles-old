...
set foldlevel=5             " Set the folding level
...
" CtrlP ignore list
set wildignore+=*/.git/*,*/.hg/*,*/.svn/*,*/.DS_Store,*/*.pyc,*/*.pyo,*/.*.swp

" Trim spaces
autocmd FileType c,php,python,html,javascript,htmldjango autocmd BufWritePre <buffer> :%s/\s\+$//e
